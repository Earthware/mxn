...
Geocoder: {
	...
	geocode: function(address, rowlimit){
		...
		The geocoding target country is specified using the "adminArea1" or "country" request parameter (Refer to the Locations documentation). Country designation is currently not supported for single-line addressing. The United States is assumed for all single-line addresses.
		
		*/
		
		MQA.Geocoder.geocode(address, options, null, 
		function(results) {
